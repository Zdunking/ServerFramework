...
namespace zdunk
{
    ...
    static zdunk::ConfigVar<std::string>::ptr g_module_path = Config::Lookup("module.path", std::string("module"), "module path");
    ...
    // bool Module::handleRequest(zdunk::Message::ptr req, zdunk::Message::ptr rsp, zdunk::Stream::ptr stream)
    // {
    ...
    // bool Module::handleNotify(zdunk::Message::ptr notify, zdunk::Stream::ptr stream)
    // {
    ...
    bool Module::onConnect(zdunk::Stream::ptr stream)
    {
        return true;
    }

    bool Module::onDisconnect(zdunk::Stream::ptr stream)
    {
        return true;
    }
    ...
    // bool RockModule::handleRequest(zdunk::Message::ptr req, zdunk::Message::ptr rsp, zdunk::Stream::ptr stream)
    // {
    //     auto rock_req = std::dynamic_pointer_cast<zdunk::RockRequest>(req);
    //     auto rock_rsp = std::dynamic_pointer_cast<zdunk::RockResponse>(rsp);
    //     auto rock_stream = std::dynamic_pointer_cast<zdunk::RockStream>(stream);
    //     return handleRockRequest(rock_req, rock_rsp, rock_stream);
    // }

    // bool RockModule::handleNotify(zdunk::Message::ptr notify, zdunk::Stream::ptr stream)
    // {
    //     auto rock_nty = std::dynamic_pointer_cast<zdunk::RockNotify>(notify);
    //     auto rock_stream = std::dynamic_pointer_cast<zdunk::RockStream>(stream);
    ...
    void ModuleManager::init()
    {
        ...
        zdunk::FSUtil::ListAllFile(files, path, ".so");
