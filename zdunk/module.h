...
namespace zdunk
{
    ...
    public:
        ...
        virtual bool onConnect(zdunk::Stream::ptr stream);
        virtual bool onDisconnect(zdunk::Stream::ptr stream);

        virtual bool onServerReady();
        virtual bool onServerUp();

        // virtual bool handleRequest(zdunk::Message::ptr req, zdunk::Message::ptr rsp, zdunk::Stream::ptr stream);
        // virtual bool handleNotify(zdunk::Message::ptr notify, zdunk::Stream::ptr stream);
    ...
    //     virtual bool handleRockRequest(zdunk::RockRequest::ptr request, zdunk::RockResponse::ptr response, zdunk::RockStream::ptr stream) = 0;
    //     virtual bool handleRockNotify(zdunk::RockNotify::ptr notify, zdunk::RockStream::ptr stream) = 0;
    ...
    typedef zdunk::Singleton<ModuleManager> ModuleMgr;
