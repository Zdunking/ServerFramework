...
namespace zdunk
{
    ...
    public:
        ...
        FoxRedis(zdunk::FoxThread *thr, const std::map<std::string, std::string> &conf);
        ~FoxRedis();
    ...
    private:
        ...
        {
            std::string cmd;
            zdunk::Scheduler *scheduler;
            zdunk::Fiber::ptr fiber;
            ReplyPtr rpy;
        };
    ...
    public:
        ...
        FoxRedisCluster(zdunk::FoxThread *thr, const std::map<std::string, std::string> &conf);
        ~FoxRedisCluster();
