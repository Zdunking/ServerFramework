...
namespace zdunk
{
    ...
    static zdunk::ConfigVar<uint32_t>::ptr g_daemon_restart_interval = zdunk::Config::Lookup("daemon.restart_interval", (uint32_t)5, "daemon restart interval");
    ...
    std::string ProcessInfo::toString() const
    {
        ...
        ss << "[ProcessInfo parent_id=" << parent_id
           << " main_id=" << main_id
           << " parent_start_time=" << zdunk::Time2Str(parent_start_time)
           << " main_start_time=" << zdunk::Time2Str(main_start_time)
